...
function visualizeMigration(data) {
    ...
    // Create a group for migration paths that will be updated on map movement
    const migrationGroup = flowMapG.append("g").attr("class", "migration-paths");
    ...
    // Function to update path positions based on map view
    function updatePaths() {
        console.log("Called")
        migrationGroup.selectAll("path").remove();
    ...
    myMap.on("moveend", updatePaths);
    myMap.on("zoomend", updatePaths);
}
