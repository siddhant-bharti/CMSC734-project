...
function updateLayers() {
    nodeLinkG.selectAll('.grid-link')
    .attr('x1', function(d){return myMap.latLngToLayerPoint(d.originCoord).x})
    .attr('y1', function(d){return myMap.latLngToLayerPoint(d.originCoord).y})
    .attr('x2', function(d){return myMap.latLngToLayerPoint(d.destinationCoord).x})
    .attr('y2', function(d){return myMap.latLngToLayerPoint(d.destinationCoord).y});
}
